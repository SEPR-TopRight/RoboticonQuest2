...
public class RPSAI {
	...
	public static enum moves{ROCK, PAPER, SCISSORS};
	public static enum results{TIE, WIN, LOSE};
	...
	public results getResult() {
		 ...
		 *
		 * <rock, paper, scissors> are designated <0, 1, 2>
		 * Let player choice be n and AI choice be m, and results be from human
		 * perspective
		 *
